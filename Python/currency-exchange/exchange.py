...
def get_change(budget, exchanging_value):
    ...
    money_left = float(budget - exchanging_value)
    return money_left
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    amount_in_foreign_currency = budget/new_exchange_rate
    return (amount_in_foreign_currency//denomination)*denomination